    ...
    <div class="col-span-12 lg:col-span-7 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <form action="{{ route('advertisements.update', $advertisement->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <p class="text-xs text-gray-505 mt-1">Biarkan kosong jika tidak ingin mengubah gambar.</p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="position" class="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-slate-900 dark:text-white px-4 py-2">
                        <option value="slot1" {{ old('position', $advertisement->position) == 'slot1' ? 'selected' : '' }}>Slot 1 (Grid Kiri Atas - Kurs)</option>
                        <option value="slot2" {{ old('position', $advertisement->position) == 'slot2' ? 'selected' : '' }}>Slot 2 (Grid Kiri Bawah - Emas)</option>
                        <option value="slot3" {{ old('position', $advertisement->position) == 'slot3' ? 'selected' : '' }}>Slot 3 (Grid Tengah - Bawah Slider)</option>
                        <option value="slot4" {{ old('position', $advertisement->position) == 'slot4' ? 'selected' : '' }}>Slot 4 (Grid Tengah - Sela Card)</option>
                        <option value="slot5" {{ old('position', $advertisement->position) == 'slot5' ? 'selected' : '' }}>Slot 5 (Grid Tengah - Atas Terkini)</option>
                        <option value="slot6" {{ old('position', $advertisement->position) == 'slot6' ? 'selected' : '' }}>Slot 6 (Grid Tengah - Sela Terkini)</option>
                        <option value="slot7" {{ old('position', $advertisement->position) == 'slot7' ? 'selected' : '' }}>Slot 7 (Grid Tengah - Atas Footer)</option>
                        <option value="slot8" {{ old('position', $advertisement->position) == 'slot8' ? 'selected' : '' }}>Slot 8 (Grid Kanan - Bawah Terpopuler)</option>
                        <option value="slot9" {{ old('position', $advertisement->position) == 'slot9' ? 'selected' : '' }}>Slot 9 (Grid Kanan - Bawah Topik)</option>
                        <option value="slot10" {{ old('position', $advertisement->position) == 'slot10' ? 'selected' : '' }}>Slot 10 (Grid Kanan - Bawah Sorotan)</option>
                    </select>
                </div>
                <div>
