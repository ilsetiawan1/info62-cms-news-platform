...
<div class="p-6 max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-xl font-bold text-slate-800">Tambah Sosial Media Baru</h1>
            <p class="text-sm text-slate-500">Tautan sosial media ini akan tampil secara dinamis di footer halaman publik.</p>
        </div>
    </div>

    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        <form action="{{ route('socials.store') }}" method="POST" class="space-y-5">
            @csrf
